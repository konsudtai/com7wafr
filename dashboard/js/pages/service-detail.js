...
const ServiceDetailPage = (() => {
  ...
  const SERVICE_META = {
    ...
    'api gateway': { name: 'API Gateway', icon: '<svg width="20" height="20" viewBox="0 0 40 40"><rect x="2" y="2" width="36" height="36" rx="4" fill="#8C4FFF" /><text x="20" y="26" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold" font-family="Arial">API</text></svg>' },
    apigateway:  { name: 'API Gateway', icon: '<svg width="20" height="20" viewBox="0 0 40 40"><rect x="2" y="2" width="36" height="36" rx="4" fill="#8C4FFF" /><text x="20" y="26" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold" font-family="Arial">API</text></svg>' },
    sqs:         { name: 'SQS',         icon: '<svg width="20" height="20" viewBox="0 0 40 40"><rect x="2" y="2" width="36" height="36" rx="4" fill="#ED7100" /><text x="20" y="26" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold" font-family="Arial">SQS</text></svg>' },
    opensearch:  { name: 'OpenSearch',  icon: '<svg width="20" height="20" viewBox="0 0 40 40"><rect x="2" y="2" width="36" height="36" rx="4" fill="#3334B9" /><text x="20" y="26" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold" font-family="Arial">OS</text></svg>' },
    guardduty:   { name: 'GuardDuty',   icon: '<svg width="20" height="20" viewBox="0 0 40 40"><rect x="2" y="2" width="36" height="36" rx="4" fill="#DD344C" /><text x="20" y="26" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold" font-family="Arial">GD</text></svg>' },
    efs:         { name: 'EFS',         icon: '<svg width="20" height="20" viewBox="0 0 40 40"><rect x="2" y="2" width="36" height="36" rx="4" fill="#3F8624" /><text x="20" y="26" text-anchor="middle" fill="#fff" font-size="12" font-weight="bold" font-family="Arial">EFS</text></svg>' },
    elasticache: { name: 'ElastiCache', icon: '<svg width="20" height="20" viewBox="0 0 40 40"><rect x="2" y="2" width="36" height="36" rx="4" fill="#3334B9" /><text x="20" y="26" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold" font-family="Arial">EC</text></svg>' },
    redshift:    { name: 'Redshift',    icon: '<svg width="20" height="20" viewBox="0 0 40 40"><rect x="2" y="2" width="36" height="36" rx="4" fill="#3334B9" /><text x="20" y="26" text-anchor="middle" fill="#fff" font-size="10" font-weight="bold" font-family="Arial">RS</text></svg>' },
  };
